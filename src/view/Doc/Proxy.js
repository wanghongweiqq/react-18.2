...
function Proxy () {
  return (
    <div className='pg-doc'>
      ...
      <p>配置修改后重新运行项目方可生效</p>
      <p><img alt='本地开发接口代理' src={require('@/assets/images/doc/proxy.png')} /></p>
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>secure</td>
            <td>安全策略，默认true，如果target为https，此项必须设置为false，否则接口报错500；如果target为http，此项可以不设置或设置为true/false都可以</td>
          </tr>
          <tr>
            <td>changeOrigin</td>
